...
<div class="container container-position">
    <div class="card blur">
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url('admin/biodata-pelamar/add') ?>" method="POST">
                <div class="accordion">
                  ...
                  <div class="accordion-body">
                    <div class="row g-3">
                        <div class="col-6">
                          ...
                          <select class="form-select form-style" name="user_id" required>
        ...
        <div class="col-4">
            ...
            <input type="email" class="form-control form-style" name="email" placeholder="Email Aktif*" value="<?= old('email') ?>" required>
        </div>
